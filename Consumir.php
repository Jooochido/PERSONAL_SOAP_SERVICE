<?php
$location = "http://localhost:8080/PERSONAL_SOAP_SERVICE/Insertcategoria.php?wsdl";
   ...
   <soapenv:Body>
      <ins:InsertCategoriaService soapenv:encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\">
         <InsertCategoria xsi:type=\"ins:InsertCategoria\">
            ...
            <usu_nom xsi:type=\"xsd:string\">SOAP</usu_nom>
            <usu_ape xsi:type=\"xsd:string\">UI</usu_ape>
            <usu_correo xsi:type=\"xsd:string\">soapui@gmail.com</usu_correo>
         </InsertCategoria>
